...
if (!defined('_DIR_RESTREINT_ABS')) {
	...
	define('_DIR_RESTREINT_ABS', 'BehindTheStage/');
}
...
if (!defined('_HEADER_COMPOSED_BY')) {
	define('_HEADER_COMPOSED_BY', "Composed-By: www.certifie-conforme.com");
}
if (!headers_sent() and _HEADER_COMPOSED_BY) {
	header("Vary: Cookie, Accept-Encoding");
	header(_HEADER_COMPOSED_BY . " for www.priviledger.com");
}
